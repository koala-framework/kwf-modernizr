<?php
class Kwf_Modernizr_ProviderTest extends Kwf_Test_TestCase
{
    private $_list;
    public function setUp()
    {
        parent::setUp();
        $this->_list = new Kwf_Modernizr_TestProviderList();
    }

    public function testSingleFeature()
    {
        $d = $this->_list->findDependency('ModernizrAnimation');
        $this->assertTrue($d instanceof Kwf_Modernizr_Dependency);
